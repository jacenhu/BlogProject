...
![java-env-install-01](/img/developmentEnv/javaInstall01.png)

![java-env-install-02](/img/developmentEnv/javaInstall02.png)

![java-env-install-03](/img/developmentEnv/javaInstall03.png)
...
![java-env-install-04](/img/developmentEnv/javaInstall04.png)

### step3 检测是否安装成功

![java-env-install-05](/img/developmentEnv/javaInstall05.png)
...
![mvn-env-install-01](/img/developmentEnv/mvnInstall01.png)
...
![mvn-env-install-02](/img/developmentEnv/mvnInstall02.png)

### step3 检测是否安装成功
检测是否安装成功

![mvn-env-install-03](/img/developmentEnv/mvnInstall03.png)
...
![mvn-env-install-04](/img/developmentEnv/mvnInstall04.png)
...
![idea-set-01](/img/developmentEnv/ideaSet01.png)

step2 配置mvn目录、设置文件、本地仓库。

Build，Execution，Deployment >> Build Tools >> Maven >> 

![idea-set-02](/img/developmentEnv/ideaSet02.png)
